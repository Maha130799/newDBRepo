# Ingestion_DLT_Pipeline

This folder defines all source code for the 'Ingestion_DLT_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_ingestion_dlt_pipeline.py" to get familiar with the syntax.
